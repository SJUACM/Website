    ...
    return (
        ...
        <BlogContainer2>            
            <BlogTextContainer>
                ...
                <BlogText2>
                    That was when I first made a LinkedIn account and then started my internship search. I soon realized that most internships are meant for rising seniors, and at the time, I was not aware of internships specifically meant for freshman / underclassmen such as Uber STAR, Microsoft Explore, Google STEP, and Facebook University. Nevertheless, I applied for nearly 100 positions and expectedly, I was rejected from every single one. At this point, I knew that I had to make myself stand out in some way so that I could land an internship the following year. This was when I started learning Python and working on various personal projects. With its verbose and English-like syntax, it was very simple to learn and allowed me to work on projects that would be much more difficult to do in Java.
                </BlogText2>
                ...
                <BlogText2>
                    So, after the conclusion of the Fall 2021 semester, I focused solely on my job search. I made sure to optimize my resume and add in as many keywords as I could. I was on LinkedIn, Handshake, and Indeed all day everyday just applying to different positions. I should note that I was mainly applying to top companies, I did want a name as big as Bloomberg or ideally something bigger for my next role. This clearly made things a lot harder for me, since that meant I was only applying to really competitive companies and for positions which hundreds if not thousands of other people are applying to. I kept track of my applications using google sheets (see below), where I wrote down the each position I applied for, along with the company, and my current stage of the interview process. The red cells indicate a rejection (if those cells had nothing in the "Process" column, that means I got rejected after submitting my resume) and cells with nothing in the "Process" column meant that I did not hear back. The screenshot below shows how my first 35 applications went.   
                </BlogText2>
                ...
                <BlogText2>
                I hope at this point it's clear how each step of my journey led to the next. If I didn’t do the summer research with Dr. Keshtkar, I likely wouldn’t have been in the 5 year program and would not have ended up publishing a peer reviewed research paper. That research experience helped boost my resume so that I could eventually land my Bloomberg internship, which in turn helped me land my Amazon internship. This is why the best piece of advice I can give to students, especially underclassmen, is to work on research with Professors. It can be as beneficial as an internship and it gives you hands-on experience which will pay off in future interviews. Before landing my Bloomberg internship, my research and personal projects were the only relevant experience I had. 
                </BlogText2>

                <BlogText2>
                    As I mentioned before, I wanted to write this blog post to share my story and to show the reality of breaking into Tech. Sure, it would’ve been a lot easier if I networked and got referrals, but that is easier said than done. Referrals will get you interviews, but you still have to pass them. The months I spent applying and interviewing were brutal and the mental challenges I faced really took a toll on me. This is the unfortunate reality that a lot of computer science students will face, especially now with the current state of the economy. 
                </BlogText2>

                <BlogText2>
                    What I want to stress is that throughout the months of applying and interviewing, I remained hopeful, I knew I would eventually land something that I really wanted, which ended up happening. Having self confidence is absolutely essential for achieving your goals. If you don't believe in yourself, then who will? I also am a firm believer that you can achieve anything in life, it just depends on how bad you want it and how much you’re willing to sacrifice for it. This was the mentality I had whenever I got rejected after each interview - I told myself that I didn't want it bad enough and that I didn’t prepare for it enough. Whenever you’re wondering why you haven’t achieved something yet, ask yourself: how bad do you want it? 
                </BlogText2>
