...
export const content = [
    {
        ...
        text: 'Bite-sized 5-6 hour virtual work experience programs that give students a genuine career advantage with Fortune 500 companies!',
    ...
    {
        title: 'Learn Python, R, and SQL for Free',
        text: 'Learn the data skills you need online at your own pace, with topics ranging from data science and machine learning! Solve real-world problems by applying your skills in projects.',
        link: 'https://app.datacamp.com/learn',
        img: datacamp,
    },
    {
        title: 'Check Verified Tech Salaries',
